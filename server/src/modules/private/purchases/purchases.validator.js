...
const createPurchaseValidators = [
    ...
    // validating the purchaseNumber field
    body("purchaseNumber")
        .notEmpty()
        .withMessage("Purchase number is required")
        .isString(),

    // validating the purchaseDate field
    body("purchaseDate")
        .notEmpty()
    ...
    // validating the items field
    body("items")
        .isArray({ min: 1 })
        .withMessage("Items must be a non-empty array"),

    // validating the items.*.productId field
    ...
    // validating the items.*.quantity field
    body("items.*.quantity")
        .notEmpty()
    ...
    // validating the items.*.unitPrice field
    ...
    // validating the items.*.taxId field
    body("items.*.taxId")
        .optional()
...
const approvePurchaseValidators = [
    ...
    // validating the purchaseId param
    param("purchaseId")
        .notEmpty()
